...
public class Goto01Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.goto01);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), GotosimpleActivity.class);
		...
		button1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), Goto16Activity.class);
				startActivity(intent);
			}
		});
		...
		button3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), Goto32Activity.class);
				startActivity(intent);
			}
		});
	}
