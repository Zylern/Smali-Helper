...
public class ComparisionActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.comparision);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), CmpLongActivity.class);
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), CmpgDoubleActivity.class);
				startActivity(intent);
			}
		});
		...
		button4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), CmpgFloatActivity.class);
				startActivity(intent);
			}
		});
		...
		button3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), CmplDoubleActivity.class);
				startActivity(intent);
			}
		});
		...
		button5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), CmplFloatActivity.class);
				startActivity(intent);
			}
		});
	}
